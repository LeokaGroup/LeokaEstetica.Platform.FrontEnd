...
export class SignUpComponent implements OnInit {
  ...
  formSignUp: UntypedFormGroup = new UntypedFormGroup({
    ...
    componentRoles: new UntypedFormControl(null, [Validators.required]),

    agree: new UntypedFormControl(null, [Validators.required]),
  });
  ...
  public async onSendFormSignUpAsync() {
    ...
    (
      await this._userService.signUpAsync(
  ...
  private async getComponentRolesAsync() {
    (await this._userService.getComponentRolesAsync()).subscribe((_) => {
